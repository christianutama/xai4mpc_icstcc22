...
# Only use a subset of the features identified by SHAP
data_in = np.load('./data/input_complete.npy')
U_s = np.load('./data/output_complete.npy')
...
# save model
model.save('./models/nn_controller_xai.h5')
